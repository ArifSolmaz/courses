...
WEEKS = [
    ...
    (8, "Big-O Notation",
     ...
     3, "How can we describe how the work grows with more input?",
    ...
    (11, "Dictionaries and Sets: Faster Lookups",
     "Hashing intuition and the single biggest speed win a beginner can learn.",
     4, "Why can sets and dictionaries avoid checking every item?",
     ["dict", "set", "≈3 hours"]),
    ...
    (14, "Putting It All Together",
     ...
     4, "Given a new problem, how do I choose a method and explain why it works?",
